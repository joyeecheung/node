...
#define NODE_OFFSET_POSTMORTEM_METADATA(V)                                     \
  V(BaseObject, type_, uint8_t, BaseObject::type_)                             \
  V(BaseObject,                                                                \
    persistent_handle_,                                                        \
    v8_Persistent_v8_Object,                                                   \
  ...
  V(Environment_ReqWrapQueue,                                                  \
    head_,                                                                     \
    ListNode_ReqWrapQueue,                                                     \
