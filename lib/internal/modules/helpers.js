...
// For the actual require() function available in the module wrapper function context.
// Useful for trimming internal stack frames when an error or warning is coming out
// of require().
const kRequireInContext = Symbol('kRequireInContext');
...
function makeRequireFunction(mod) {
  ...
  // Saving the actual require() function built so that errors or warnings
  // can use it to trim internal stack frames.
  mod[kRequireInContext] = require;
