...
/**
 * This function searches recursively on the prototype chain for
 * constructors and type tags.
 * Note: getConstructorOf is inlined in this function to save iterations
 *
 * @param {object} obj
 * @returns {{constructor: string, tag: string}}
 */
...
/**
 * This function accepts constructor and tag as returned by getIdentificationOf
 * @param {string} constructor
 * @param {string} tag
 * @returns {string}
 */
function getObjectType(constructor, tag) {
