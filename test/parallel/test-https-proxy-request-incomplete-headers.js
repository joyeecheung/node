...
(async () => {
  ...
  // The proxy client should get a connection timeout or close error.
  assert(stderr.includes('ERR_PROXY_ERROR') || stderr.includes('ECONNRESET') || stderr.includes('ended unexpectedly'));
