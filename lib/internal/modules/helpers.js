...
function initializeCjsConditions() {
  ...
  if (getOptionValue('--experimental-require-module')) {
    // Prioritize "require" for require(), but "import" can be a fallback.
    // TODO(joyeecheung): do we want to ignore it? Make it optional?
  ...
  if (getOptionValue('--conditions').length > 0) {
