...
let cjsConditions;
// Lazy load the conditions since it involves cli options.
function getCJSConditions() {
  if (cjsConditions === undefined) {
    const userConditions =
      require('internal/options').getOptionValue('--conditions');
    cjsConditions = new SafeSet(['require', 'node', ...userConditions]);
  }
