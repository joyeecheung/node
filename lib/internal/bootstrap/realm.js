...
class BuiltinModule {
  ...
  getExportValues() {
    ...
    return ArrayPrototypeMap(this.exportKeys,
      (name) => ObjectHasOwn(mod, name) ? mod[name] : undefined);
  }
  ...
  getESMFacade() {
    ...
    const values = this.getExportValues();
    ArrayPrototypePush(values, this.exports);  // This would be set as "default"
    this.module = new ModuleWrap(url, is_builtin_facade, this.exportKeys, values);
    return this.module;
  }
  ...
  syncExports() {
    if (this.module) {
      this.module.syncBuiltinFacade(this.getExportValues());
    }
  }
