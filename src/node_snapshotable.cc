...
constexpr const char* kAnonymousSnapshotMainName = "_anonymous_snapshot_main";

std::string GetAnonymousSnapshotMainName() {
  return kAnonymousSnapshotMainName;
}
...
void CreatePerIsolateProperties(IsolateData* isolate_data,
  ...
  SetMethod(isolate,
            ...
            SetDeserializeMainFunction);
  target->Set(FIXED_ONE_BYTE_STRING(isolate, "anonymousSnapshotMainName"),
              OneByteString(isolate, kAnonymousSnapshotMainName));
}
