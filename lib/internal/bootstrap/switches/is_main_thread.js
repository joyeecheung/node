...
require('util');
require('url');
// The net and stream modules are needed in many other places.
// They are also depended on by tty but just be explicit here.
require('net');
require('stream');
// Needed by console.log() to terminal, which is where startup performance
// matters.
require('tty');
// Module loaders.
