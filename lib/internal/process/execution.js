...
/**
 * Evaluate an ESM and return the promise that gets fulfilled after it finishes evaluation.
 * @param {string} source Source code the ESM
 * @param {boolean} print Whether it's for --print
 * @returns {Promise}
 */
