...
class ExampleCppgcObject final
 ...
 public:
  ...
  ExampleCppgcObject(Environment* env, Local<Object> obj)
      : env_(env), traced_reference_(env->isolate(), obj) {}

  SET_MEMORY_INFO_NAME(ExampleCppgcObject)
  SET_SELF_SIZE(ExampleCppgcObject)
  SET_NO_MEMORY_INFO()
