...
const {
  config: rawConfig,
  setNativeModuleRequire,
  setInternalBindingLoader
} = internalBinding('native_module');
// process.config is serialized config.gypi
process.config = JSON.parse(rawConfig);
// Store references to these for main scripts to use
setNativeModuleRequire(NativeModule.require);
setInternalBindingLoader(internalBinding);
