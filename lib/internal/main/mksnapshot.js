...
function main() {
  ...
  function minimalRunESM(content) {
    assert.fail('ES Modules are currently not supported as snapshot builder entrypoints');
  }

  return [process, requireForUserSnapshot, minimalRunCjs, minimalRunESM];
}
