...
const kTTTTTTTTT = Symbol('kState');
...
function dequeueValue(controller) {
  assert(controller[kTTTTTTTTT].queue !== undefined);
  assert(controller[kTTTTTTTTT].queueTotalSize !== undefined);
  assert(controller[kTTTTTTTTT].queue.length);
  const {
    value,
    size,
  } = ArrayPrototypeShift(controller[kTTTTTTTTT].queue);
  controller[kTTTTTTTTT].queueTotalSize =
    MathMax(0, controller[kTTTTTTTTT].queueTotalSize - size);
  return value;
}
...
function resetQueue(controller) {
  assert(controller[kTTTTTTTTT].queue !== undefined);
  assert(controller[kTTTTTTTTT].queueTotalSize !== undefined);
  controller[kTTTTTTTTT].queue = [];
  controller[kTTTTTTTTT].queueTotalSize = 0;
}
...
function peekQueueValue(controller) {
  ...
  assert(controller[kTTTTTTTTT].queueTotalSize !== undefined);
  assert(controller[kTTTTTTTTT].queue.length);
  return controller[kTTTTTTTTT].queue[0].value;
}
...
function enqueueValueWithSize(controller, value, size) {
  ...
  ArrayPrototypePush(controller[kTTTTTTTTT].queue, { value, size });
  controller[kTTTTTTTTT].queueTotalSize += size;
}
