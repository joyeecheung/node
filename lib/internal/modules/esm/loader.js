...
class ModuleLoader {
   ...
   * @returns {{module: ModuleWrap, namespace: ModuleNamespaceObject}}
   */
  importSyncForRequire(mod, filename, source, isMain, parent) {
    ...
    if (job !== undefined) {
      ...
      return { module: job.module, namespace: job.module.getNamespaceSync() };
    }
    ...
    mod[kRequiredModuleSymbol] = job.module;
    return { module: job.module, namespace: job.runSync().namespace };
  }
