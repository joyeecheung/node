 ...
 */
function createCJSModuleWrap(url, translateContext, parentURL, format, loadCJS = loadCJSModule) {
...
translators.set('commonjs-sync', function requireCommonJS(url, translateContext, parentURL) {
  ...
  return createCJSModuleWrap(url, translateContext, parentURL, 'commonjs', loadCJSModuleWithModuleLoad);
});
...
translators.set('require-commonjs', (url, translateContext, parentURL) => {
  ...
  return createCJSModuleWrap(url, translateContext, parentURL, 'commonjs');
});
...
translators.set('require-commonjs-typescript', (url, translateContext, parentURL) => {
  ...
  return createCJSModuleWrap(url, translateContext, parentURL, 'commonjs-typescript');
});
...
translators.set('commonjs', function commonjsStrategy(url, translateContext, parentURL) {
  ...
  // hooks twice.
  const cjsLoader = (translateContext.shouldBeReloadedByCJSLoader || translateContext.source == null) ?
    loadCJSModuleWithModuleLoad : loadCJSModule;
  ...
  return createCJSModuleWrap(url, translateContext, parentURL, 'commonjs', cjsLoader);
});
 ...
 */
function cjsEmplaceModuleCacheEntryForURL(url, parent) {
  const filename = urlToFilename(url);
  if (!filename) {
    return;
  }
